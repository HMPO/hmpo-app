...
describe('No Cache', () => {
    ...
    describe('middleware', () => {
        it('should set no cache headers', () => {
            ...
            res.setHeader.getCall(0).should.have.been.calledWithExactly('Pragma', 'no-cache');
            res.setHeader.getCall(1).should.have.been.calledWithExactly('Surrogate-Control', 'no-store');
            res.setHeader.getCall(2).should.have.been.calledWithExactly('Cache-Control', 'no-store, no-cache, must-revalidate, proxy-revalidate');
